      ...
      if (isLogin) {
        ...
        if (error) {
          ...
          toast({
            ...
            description: 'Welcome to SupportAI. You can now start chatting.',
          });
          navigate('/chat');
        }
      }
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <header className="relative z-10 flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold text-foreground">SupportAI</span>
        </div>
      </header>
          ...
          <div className="bg-card border border-border rounded-2xl p-8 shadow-xl">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">
                {isLogin 
                  ...
                  : 'Sign up to get started with SupportAI'}
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full bg-primary hover:bg-primary/90 text-primary-foreground py-6 rounded-xl text-lg font-medium"
              >
                {isLoading 
